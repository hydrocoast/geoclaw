...
def setrun(claw_pkg='geoclaw'):
    ...
    clawdata.lower[0] =   0.0e3    # west longitude
    clawdata.upper[0] = 400.0e3    # east longitude

    clawdata.lower[1] =    0.0e3     # south latitude
    clawdata.upper[1] =  800.0e3    # north latitude
    ...
    rundata.gaugedata.gauges.append([1,  50.0e3,  50.0e3, rundata.clawdata.t0, rundata.clawdata.tfinal])
    rundata.gaugedata.gauges.append([2, 100.0e3, 100.0e3, rundata.clawdata.t0, rundata.clawdata.tfinal])
    rundata.gaugedata.gauges.append([3, 150.0e3, 150.0e3, rundata.clawdata.t0, rundata.clawdata.tfinal])
    rundata.gaugedata.gauges.append([4, 200.0e3, 200.0e3, rundata.clawdata.t0, rundata.clawdata.tfinal])
...
def setgeo(rundata):
    ...
    fg.dt_check = 2.         # target time (sec) increment between updating max values
